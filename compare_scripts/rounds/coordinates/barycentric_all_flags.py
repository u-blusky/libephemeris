#!/usr/bin/env python3
"""Round 88: Barycentric All Planets with Flag Combinations"""
...
print("=" * 70)
print("ROUND 88: Barycentric All Planets with Flag Combinations")
print("=" * 70)
...
total = passed + failed
print("\n" + "=" * 70)
print(f"ROUND 88 FINAL: {passed}/{total} passed ({100 * passed / total:.1f}%)")
