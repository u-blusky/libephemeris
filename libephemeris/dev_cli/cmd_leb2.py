...
@convert_group.command("base-core")
def base_core() -> None:
...
@convert_group.command("base-asteroids")
...
@convert_group.command("base-apogee")
...
@convert_group.command("base-uranians")
