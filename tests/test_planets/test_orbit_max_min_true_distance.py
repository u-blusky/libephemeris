...
class TestOrbitMaxMinTrueDistanceBasic:
    ...
    def test_returns_tuple_of_two_floats(self):
        """orbit_max_min_true_distance should return a tuple of two floats."""
        jd = 2451545.0  # J2000
    ...
    def test_min_less_than_max(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_MARS, 0)

        assert min_dist < max_dist

    @pytest.mark.unit
    def test_sun_returns_zeros(self):
        """Sun should return (0.0, 0.0) as it has no geocentric orbit."""
        jd = 2451545.0
    ...
    def test_earth_returns_zeros(self):
        """Earth should return (0.0, 0.0) as it is the observer."""
        jd = 2451545.0
...
class TestOrbitMaxMinTrueDistanceMoon:
    ...
    def test_moon_min_is_perigee(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_MOON, 0)
...
class TestOrbitMaxMinTrueDistanceInnerPlanets:
    ...
    def test_mercury_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_MERCURY, 0)
    ...
    def test_venus_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_VENUS, 0)
...
class TestOrbitMaxMinTrueDistanceOuterPlanets:
    ...
    def test_jupiter_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_JUPITER, 0)
    ...
    def test_saturn_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_SATURN, 0)
    ...
    def test_uranus_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_URANUS, 0)
    ...
    def test_neptune_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_NEPTUNE, 0)
    ...
    def test_pluto_distance_range(self):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, SE_PLUTO, 0)
...
class TestOrbitMaxMinTrueDistanceAllPlanets:
    ...
    def test_all_planets_return_positive_distances(self, planet_id, planet_name):
        ...
        jd = 2451545.0
        min_dist, max_dist = ephem.orbit_max_min_true_distance(jd, planet_id, 0)
