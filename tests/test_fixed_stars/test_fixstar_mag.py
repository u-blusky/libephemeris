...
class TestFixstarMag:
    ...
    def test_fixstar_mag_regulus(self):
        ...
        mag = ephem.swe_fixstar_mag("Regulus")
    ...
    def test_fixstar_mag_spica(self):
        ...
        mag = ephem.swe_fixstar_mag("Spica")
    ...
    def test_fixstar_mag_case_insensitive(self):
        ...
        mag_upper = ephem.swe_fixstar_mag("REGULUS")
        mag_lower = ephem.swe_fixstar_mag("regulus")
        mag_mixed = ephem.swe_fixstar_mag("ReGuLuS")
    ...
    def test_fixstar_mag_alias(self):
        ...
        mag1 = ephem.swe_fixstar_mag("Regulus")
        mag2 = ephem.fixstar_mag("Regulus")
...
class TestMagnitudeValues:
    ...
    def test_spica_brighter_than_regulus(self):
        ...
        mag_spica = ephem.swe_fixstar_mag("Spica")
        mag_regulus = ephem.swe_fixstar_mag("Regulus")
