...
class TestTidAccConstants:
    ...
    def test_tidal_automatic_is_999999(self):
        """SE_TIDAL_AUTOMATIC should be 999999 (pyswisseph compat)."""
        assert ephem.SE_TIDAL_AUTOMATIC == 999999

    @pytest.mark.unit
    def test_tidal_default_is_minus_25_8(self):
        """SE_TIDAL_DEFAULT should be -25.8 (pyswisseph compat)."""
        assert ephem.SE_TIDAL_DEFAULT == -25.8
